...
- **Loss Function** – Measures how far the prediction is from the actual output. Here, **Binary Cross-Entropy (BCE)** loss is used since it's a binary classification problem.
